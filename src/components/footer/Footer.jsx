      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 relative z-20">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 sm:gap-12 lg:gap-[20px]">
          ...
          <div className="flex w-full lg:w-1/5 flex-col items-start gap-4 sm:gap-5">
            ...
            <p
              className={`text-sm sm:text-base text-gray-400 leading-tight max-w-full lg:max-w-[280px] ${
          ...
          <div className="flex flex-col sm:flex-row lg:flex-row w-full lg:w-4/5 gap-8 sm:gap-12 lg:gap-[40px]">
            {/* Quick Links Section */}
            <div
              className={`flex flex-col gap-4 sm:gap-[20px] flex-1 ${
                isRTL ? "items-end" : "items-start"
              }`}
            >
              <h4 className="text-lg sm:text-[20px] font-semibold text-white">
                {t("footer.quickLinks")}
              </h4>
              <div
                className={`flex flex-col gap-3 sm:gap-[12px] text-sm sm:text-[16px] text-gray-400 ${
                  isRTL ? "items-end" : "items-start"
                }`}
              >
                <button
                ...
                <button
                  ...
                  className="hover:text-white transition-colors duration-200"
                >
                  {t("footer.navigation.industries")}
                </button>
                <button
            ...
            <div
              className={`flex flex-col gap-5 sm:gap-[30px] flex-1 ${
                isRTL ? "items-end" : "items-start"
              }`}
            >
              <h4 className="text-lg sm:text-[20px] font-semibold text-white">
              ...
              <div
                className={`flex flex-col gap-4 sm:gap-[24px] ${
                  isRTL ? "items-end" : "items-start"
                }`}
              >
                <div
                  className={`flex items-start gap-3 sm:gap-[12px] ${
                ...
                >
                  ...
                  <div className={isRTL ? "text-right" : "text-left"}>
                    <p className="text-sm sm:text-[16px] font-semibold text-white mb-1 sm:mb-2">
                      {t("footer.headOffice")}
                    </p>
                    <p className="text-sm sm:text-base text-gray-400 leading-relaxed">
                      {t("footer.address")} <br />
                      <span dir="rtl" className="text-gray-400">
                        {t("footer.addressArabic")}
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div
                  className={`flex items-center gap-3 sm:gap-[12px] ${
                    isRTL ? "flex-row-reverse" : ""
                  }`}
                >
                  ...
                  <div className="text-sm sm:text-[16px] text-gray-400">
                    {t("footer.phone")}
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="text-sm sm:text-[16px] text-gray-400 break-all sm:break-normal">
                    {t("footer.email")}
                  </div>
                </div>
              </div>
            ...
            <div
              className={`flex flex-col gap-5 sm:gap-[30px] flex-1 lg:flex-none lg:w-auto ${
                isRTL ? "items-end" : "items-start"
              }`}
            >
              <h4 className="text-lg sm:text-[20px] font-semibold text-white">
              ...
              <div className="flex gap-3 sm:gap-[12px]">
                <a
                  href="https://www.instagram.com/goldensucces_?igsh=MXN5d2I0dmFhZ3ZyNw=="
                  target="_blank"
                  className="p-2 sm:p-3 rounded-full border border-gray-600 hover:border-gray-400 hover:bg-gray-700 transition-all duration-200"
                >
                  <Instagram size={18} className="sm:w-5 sm:h-5" />
                </a>
                <a
                  href="https://linkedin.com/company/goldensuccessksa"
                  target="_blank"
                  className="p-2 sm:p-3 rounded-full border border-gray-600 hover:border-gray-400 hover:bg-gray-700 transition-all duration-200"
                >
        ...
        <div
          className={`flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 sm:gap-4 text-gray-500 text-xs sm:text-[14px] ${
        ...
        >
          ...
          <div
            className={`flex items-center gap-2 text-xs sm:text-[14px] ${
              isRTL ? "flex-row-reverse" : ""
            }`}
          >
      ...
      <div className="absolute bottom-4 sm:bottom-6 lg:bottom-[40px] right-4 sm:right-6 lg:right-[40px] z-30">
        <button
          ...
          className="flex justify-center items-center w-8 h-8 sm:w-10 sm:h-10 lg:w-[40px] lg:h-[40px] rounded-full border-2 sm:border-[2.5px] border-white text-white
                     ...
                     group"
        >
          <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 transform -rotate-90 transition-transform duration-200 ease-in-out group-hover:scale-125" />
        </button>
      </div>
    </footer>
  );
