    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {showText && (
          <>
            ...
            <ChevronDown
              className={`w-4 h-4 text-gray-600 group-hover:text-[#04C39A] transition-all duration-300 ${
                isOpen ? "rotate-180" : ""
              }`}
            />
          </>
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div
            className={`absolute top-full mt-3 bg-white border border-gray-200 rounded-xl shadow-xl z-20 min-w-[160px] overflow-hidden ${
