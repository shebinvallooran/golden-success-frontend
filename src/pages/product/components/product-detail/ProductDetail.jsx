...
export const ProductDetail = ({
  ...
  return (
    ...
    >
      <div
        className={`grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 lg:gap-16 max-w-7xl mx-auto ${
          isRTL ? "lg:grid-cols-[3fr_2fr]" : ""
        }`}
      >
        {/* Product Image */}
        <motion.div
        ...
        >
          ...
          <div
            className={`text-gray-600 text-sm leading-relaxed ${
              isRTL ? "font-cairo text-right rtl" : "text-left ltl"
            }`}
          ...
          >
            <button
              onClick={onBackToList}
              className={`border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-full transition-colors flex items-center gap-2 ${
            ...
            <button
              ...
              className={`btn btn-gradient inline-flex items-center text-sm sm:text-base ${
                isRTL ? "font-cairo flex-row-reverse" : ""
              }`}
              style={{ padding: "8px 16px", fontSize: "14px" }}
            >
