...
function WhatWeDo() {
  ...
  return (
    <motion.div
      className="what-we-do relative bg-[#FAF9F6]"
      initial="hidden"
      whileInView="visible"
        ...
        >
          ...
          >
            <ServiceCard
              ...
              description={t(
                "home.whatWeDo.services.medicalStores.description"
              )}
            />
          </motion.div>
          ...
          >
            <ServiceCard
              ...
              description={t(
                "home.whatWeDo.services.diagnosticCenters.description"
              )}
            />
          </motion.div>
          ...
          >
            <ServiceCard
              ...
              description={t(
                "home.whatWeDo.services.researchInstitutions.description"
              )}
            />
          </motion.div>
        </motion.div>
