...
const ContactUs = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 font-sans">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#00271F] mb-2">
        ...
        <div className="flex items-start mb-6">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 mb-1">
              {t("contact.contactUs.address.label")}
            </p>
      ...
      {/* Social Links */}
      <div>
        <h3 className="text-base font-semibold text-[#00271F] mb-3">
          {t("contact.contactUs.social.title")}
        </h3>
        <div className="flex space-x-2">
          <a
            href="#"
            className="w-8 h-8 bg-[#00271F] rounded flex items-center justify-center hover:opacity-80 transition-opacity"
          >
